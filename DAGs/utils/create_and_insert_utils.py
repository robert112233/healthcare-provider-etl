...
def create_random_patient():
    ...
    return {'last_updated': last_updated, 'first_name': first_name, 'last_name': last_name, 'date_of_birth': date_of_birth, 'sex': sex, 'height': height, 'weight': weight, 'phone_number': phone_number, 'address': address}
...
def create_first_name():
    ...
    names = {'female': ["Alice", "Daisy", "Fiona", "Hannah", "Ivy", "Katie", "Mia", "Olivia", "Ruby", "Tina", "Uma", "Willow", "Yara", "Delilah", "Freya",
                "Hazel", "Isla", "Kylie", "Nina", "Penny", "Rosie", "Ursula", "Violet", "Xena", "Yvonne", "Amber", "Chloe", "Ella", "Grace", "Iris",
                "Keria", "Lila", "Nora", "Phoebe", "Sophia", "Vanessa", "Ximena", "Yasmin", "Zoe", "Brooke", "Diana", "Faith", "Harper", "Isabelle",
                "Kayla", "Kat", "Katie", "Katherine", "Liz", "Lizzie", "Elizabeth", "Eliza", "Ellie", "Beth", "Bettie"],
             'male' : ["Bob", "Charlie", "Ethan", "George", "Jack", "Liam", "Noah", "Paul", "Quinn", "Sam", "Victor", "Xander", "Zane", "Aaron", "Caleb",
                "Elliot", "Gabriel", "Jacob", "Logan", "Mason", "Oscar", "Quentin", "Sebastian", "Toby", "Wyatt", "Zachary", "Blake", "Dylan", "Finn",
                "Henry", "James", "Max", "Owen", "Quincy", "Ryan", "Thomas", "Wesley", "Adrian", "Cameron", "Evan", "Gavin", "Jonah", "Lucas"]}
